...
def distance(a_lat, a_lon, b_lat, b_lon):
    ...
    a_lat_sin = math.sin(rad_a_lat)
    b_lat_sin = math.sin(rad_b_lat)
    a_lat_cos = math.cos(rad_a_lat)
    b_lat_cos = math.cos(rad_b_lat)
    delta = rad_a_lon - rad_b_lon
...
print(distance(53.911386, 27.446199, 53.508731, 28.149863))
